...
export default function TailorCard({ data, company }) {
  ...
  return (
    <div className="animate-fade-in bg-white rounded-xl shadow-sm border border-emerald-200 p-6">
      ...
      {link ? (
        <a
          ...
          className="inline-flex items-center gap-2 mt-2 px-4 py-2 bg-emerald-600 text-white rounded-lg text-sm font-medium hover:bg-emerald-700 transition"
        >
        ...
        <p className="text-sm text-gray-400 mt-2">Drive upload unavailable</p>
      )}
    </div>
  );
}
