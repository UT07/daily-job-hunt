...
\begin{itemize}
  ...
  \item Sole developer: designed the full architecture (React Native + Firebase + 9 Cloud Functions), built CI/CD with EAS Build, integrated PostHog analytics, and implemented gamification that drives daily active usage through cat avatar progression and streak rewards.
\end{itemize}
\vspace{0.10em}
